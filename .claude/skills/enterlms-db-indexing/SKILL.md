---
name: enterlms-db-indexing
description: Database indexing patterns for EnterLMS. Use when optimizing slow queries, adding composite indexes, or identifying missing indexes.
triggers:
  - slow query
  - missing index
  - database index
...
# EnterLMS Database Indexing Pattern
...
## Common Index Patterns for EnterLMS
