---
name: enterlms-architecture
description: Domain-Driven Design patterns, service layer, rich models, DTOs, and JsonResource for EnterLMS. Use when creating services, DTOs, or working with domain layer code.
triggers:
  - create service
  - new service
  - domain service
