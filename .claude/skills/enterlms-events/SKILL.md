---
name: enterlms-events
description: Event-driven architecture patterns for EnterLMS. Use when creating domain events, event listeners, or implementing audit logging.
triggers:
  - domain event
  - create event
  - dispatch event
...
# EnterLMS Event-Driven Architecture
