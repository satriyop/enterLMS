---
name: enterlms-testing
description: Pest testing conventions and patterns for EnterLMS. Use when writing tests, understanding test organization, or using factory states.
triggers:
  - write test
  - create test
  - pest test
