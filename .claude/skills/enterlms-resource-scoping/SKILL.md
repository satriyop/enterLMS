---
name: enterlms-resource-scoping
description: Resource scoping and authorization patterns for nested routes in EnterLMS. Use when working with parent-child resource relationships, validating foreign keys, or preventing cross-resource manipulation.
triggers:
  - nested route
  - parent child
  - belongs to
...
# EnterLMS Resource Scoping Patterns
