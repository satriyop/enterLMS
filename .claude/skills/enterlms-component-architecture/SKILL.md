---
name: enterlms-component-architecture
description: Component extraction patterns, page refactoring guidelines, and architecture conventions for EnterLMS Vue components. Use when refactoring pages over 200 lines, extracting reusable components, or consolidating duplicate patterns.
triggers:
  - refactor component
  - extract component
  - page too long
...
# EnterLMS Component Architecture
...
See `/Users/satriyo/dev/laravel-project/enterlms/.claude/skills/enterlms-component-architecture.md` for complete patterns, examples, and refactoring checklist.
