---
name: enterlms-eloquent-gotchas
description: Eloquent anti-patterns and gotchas discovered in EnterLMS. Use when working with transactions, model refreshing, service layer patterns, or debugging unnecessary database queries.
triggers:
  - fresh()
  - refresh()
  - transaction
...
// See enterlms-architecture skill for EnrollmentContext DTO pattern
