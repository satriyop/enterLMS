---
name: enterlms-concurrency
description: Race condition prevention and pessimistic locking patterns for EnterLMS. Use when handling concurrent user operations, enrollment flows, or any operation where double-submission could cause issues.
triggers:
  - race condition
  - concurrent
  - lockForUpdate
