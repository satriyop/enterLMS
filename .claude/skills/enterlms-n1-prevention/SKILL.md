---
name: enterlms-n1-prevention
description: N+1 query prevention patterns for EnterLMS. Use when optimizing loops, replacing in-loop queries, or debugging slow list/dashboard pages.
triggers:
  - N+1
  - slow query
  - query loop
...
# EnterLMS N+1 Prevention Pattern
