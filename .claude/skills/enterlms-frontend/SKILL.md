---
name: enterlms-frontend
description: Vue 3 + Inertia + TypeScript patterns for EnterLMS. Use when building Vue components, composables, TypeScript types, or frontend features.
triggers:
  - vue component
  - inertia page
  - frontend
