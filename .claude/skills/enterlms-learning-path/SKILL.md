---
name: enterlms-learning-path
description: Parent-child enrollment patterns, cross-domain event sync, re-enrollment handling, and progress calculation for Learning Path feature in EnterLMS. Use when working on hierarchical enrollment systems, progress tracking across related entities, or state synchronization between domains.
---

# EnterLMS - Learning Path Enrollment Patterns
...
- `enterlms-state-machines` - Spatie states, model relationships
- `enterlms-testing` - Testing patterns
