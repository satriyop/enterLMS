---
name: enterlms-debugging
description: Root cause analysis patterns for EnterLMS. Use when debugging type errors, data transformation issues, or encountering unexpected behavior to find and fix the source rather than applying workarounds.
triggers:
  - type error
  - TypeError
  - type mismatch
...
# EnterLMS Debugging & Root Cause Analysis
