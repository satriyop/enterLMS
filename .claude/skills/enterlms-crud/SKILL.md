---
name: enterlms-crud
description: Consistent CRUD page patterns (full-stack) for EnterLMS. Use when building list pages, form pages, or resource controllers.
triggers:
  - create page
  - index page
  - edit page
