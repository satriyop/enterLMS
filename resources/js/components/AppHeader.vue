                            ...
                            >
                                <nav class="-mx-3 space-y-1">
                                    <Link
                                        ...
                                        :key="item.title"
                                        :href="item.href"
                                        class="flex items-center gap-x-3 rounded-lg px-3 py-2 text-sm font-medium hover:bg-primary-soft"
                        ...
                        <DropdownMenuTrigger :as-child="true">
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <AvatarFallback
                                        class="rounded-lg bg-surface-3 font-semibold text-foreground"
                                    >
