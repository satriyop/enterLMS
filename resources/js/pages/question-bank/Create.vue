...
import { store, index } from '@/actions/App/Http/Controllers/QuestionBankController';
...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        <Head title="Buat Pertanyaan Bank Soal" />

        <div class="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
            <PageHeader
                title="Buat Pertanyaan Baru"
                description="Tambah pertanyaan ke bank soal untuk digunakan di berbagai penilaian"
                :back-href="index().url"
            ...
            >
                <div class="space-y-6 lg:col-span-2">
                        ...
                        <div class="space-y-4">
                            <div class="space-y-2">
                                ...
                                <p class="text-xs text-muted-foreground">
                                    Untuk jawaban singkat, Anda dapat memasukkan beberapa jawaban yang dianggap benar, dipisahkan dengan koma.
                                </p>
                    ...
                    <!-- Rubric Section (Essay / File Upload) -->
                    <FormSection
